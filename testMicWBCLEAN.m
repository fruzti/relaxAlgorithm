numMic2Test = [12 15 18];
estPos(1,:) = srcPos(1:2);
for nM = 1:length(numMic2Test)
    K = numMic2Test(nM);
for it = 1:5
...
for l = 1 : numWallsAndSource
    ...
    if l > 1
        ...
        maskMax(xGrid > 0.3 & xGrid < 1.5, :) = 1;
        maskMax(:, yGrid > -0.2 & yGrid < 0.9) = 1;
        maskMax(xGrid > 0.3 & xGrid < 8,yGrid > -0.1 & yGrid < 10) = 0;
    end
    %% Update Data
...
hNumMic2{nM} = histEst2;
end
% plotRoom(micPosK, srcPos,vrtPos, estPos')
